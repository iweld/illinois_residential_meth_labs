...
/*
	Let's create a table that will allow us to manipulate the data without disturbing the
	original table.
...
-- Copy the data from the original table to our newly created table.
...
/*
	Now that we have copied our original table, let's check for any duplicate entries.  We will create a query that will 
...
DELETE 
FROM
	residential_cleaned AS rc1
USING 
	residential_cleaned AS rc2
WHERE
